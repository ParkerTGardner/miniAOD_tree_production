...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch///store//data/Run2018C/JetHT/MINIAOD/12Nov2019_UL2018_rsb-v1/10000/015CDDF7-DBCB-094D-861E-54F73012741A.root')
)
...
process.hlt = cms.EDFilter("HLTHighLevel",
    HLTPaths = cms.vstring('HLT_AK8PFJet500*'),
